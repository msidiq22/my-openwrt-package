...
if (isset($_GET['upload']) && !FM_READONLY) {
	...
	<script type='text/javascript'>
		try {
			var dropzone_min_css = 'https://cdnjs.cloudflare.com/ajax/libs/dropzone/5.5.1/min/dropzone.min.css';
		}
		catch {
	...
	<script type='text/javascript'>
		try {
			var dropzone_min_js = 'https://cdnjs.cloudflare.com/ajax/libs/dropzone/5.5.1/min/dropzone.min.js';
		}
		catch {
...
<?php if (isset($_GET['edit']) && isset($_GET['env']) && FM_EDIT_FILE):
	...
	<script type='text/javascript'>
		try {
			var ace_js = 'https://cdnjs.cloudflare.com/ajax/libs/ace/1.4.12/ace.js';
		}
		catch {
